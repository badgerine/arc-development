    ...
    <Grid container direction='column'>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={consultationIcon} alt='handshake' width='100%' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={mockupIcon} alt='pc screen' width='100%' style={{ maxWidth: matchesMD ? '40em' : 1000 }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={review} alt='magnifying glass' width='100%' style={{ maxWidth: '35em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={designIcon} alt='paint brush' width='100%' style={{ maxWidth: matchesMD ? '50em' : '45em' }} />
        </Grid>
      </Grid>
      {/*----layout container - review----*/}
      <Grid item container direction={matchesMD ? 'column' : 'row'}
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={buildIcon} alt='construction crane beside building'
            height='100%'
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={maintainIcon} alt='spanner on nut'
            height='100%'
            style={{ maxHeight: matchesMD ? '40em' : '60em' }}
          />
        </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={iterateIcon} alt='falling dominos'
            width='100%'
