...
const Revolution = (props) => {
  ...
  return (
    <Grid container direction='column'>
      ...
      <Grid item className={classes.rowContainer} style={{ marginLeft: matchesSM ? 0 : '5em', marginTop: matchesSM ? '1em' : '2em' }}>
        <Typography variant='h2' style={{ fontFamily: 'Pacifico' }} align={matchesSM ? 'center' : undefined}>
          The Revolution
        </Typography>
      </Grid>
      ...
      <Grid item container direction='row' className={classes.rowContainer} alignItems='center' justify='center'>
        <Grid item >
          <img src={visionIcon} alt='mountain through binoculars' style={{ marginRight: '5em', maxWidth: '40em' }} />
        </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={mockupIcon} alt='pc screen' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={review} alt='magnifying glass' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={designIcon} alt='paint brush' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      {/*----layout container - review----*/}
      <Grid item container direction='row'
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={buildIcon} alt='construction crane beside building' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={launchIcon} alt='rocket' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={maintainIcon} alt='spanner on nut' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src={iterateIcon} alt='falling dominos' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      <Grid>{/*----Call To Action----*/}
